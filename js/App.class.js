class App {
	...
	initEvents (){
		...
		this.ardoise.canvas.addEventListener("mousedown", function(event){
		...
		this.ardoise.canvas.addEventListener('mousemove', function(event){
		...
		this.ardoise.canvas.addEventListener("mouseup", function(event){
			this.stylo.stopDrawing(this.ardoise);
		}.bind(this));
		this.ardoise.canvas.addEventListener("mouseout", function(event){
			this.stylo.stopDrawing(this.ardoise);
		}.bind(this));
		...
		this.palette.canvas.addEventListener("click", function(event){
